...
public class OrdersController : ControllerBase
{
    ...
    [HttpGet]
    [ProducesResponseType(typeof(IReadOnlyList<OrderGetDto>), StatusCodes.Status200OK)]
    ...
    [ProducesResponseType(typeof(OrderGetDto), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    public async Task<IActionResult> Update(Guid id, [FromBody] OrderUpdateDto dto, CancellationToken ct)
    {
    ...
    [ProducesResponseType(typeof(OrderGetDto), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    public async Task<IActionResult> UpdateStatus(Guid id, [FromBody] OrderStatusRequest request, CancellationToken ct)
    {
        try { return Ok(await _service.UpdateStatusAsync(id, request.Status, ct)); }
        catch (NotFoundException ex) { return NotFound(ex.Message); }
    }
